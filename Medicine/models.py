...
class MedicineType(models.Model):
    ...
    creator = models.ForeignKey(User, on_delete=models.DO_NOTHING,
                                related_name='created_medicine_types', verbose_name='创建者id')
    create_time = models.DateTimeField(auto_now_add=True, verbose_name='创建时间')
    modifier = models.ForeignKey(User, on_delete=models.DO_NOTHING, null=True,
                                 blank=True, related_name='modified_medicine_types', verbose_name='修改者id')
...
class Medicine(models.Model):
    medicine_type = models.ForeignKey(
        MedicineType, on_delete=models.DO_NOTHING, related_name='medicine', verbose_name='药物类型id')
    ...
    creator = models.ForeignKey(User, on_delete=models.DO_NOTHING,
                                related_name='created_medicine', verbose_name='创建者id')
    create_time = models.DateTimeField(auto_now_add=True, verbose_name='创建时间')
    modifier = models.ForeignKey(User, on_delete=models.DO_NOTHING, null=True,
                                 blank=True, related_name='modified_medicine', verbose_name='修改者id')
    modify_time = models.DateTimeField(
        auto_now_add=True, null=True, blank=True, verbose_name='修改时间')
...
class MedicineHandoutRecord(models.Model):
    ...
    prescription = models.ForeignKey(Prescription, on_delete=models.DO_NOTHING,
                                     related_name='medicine_handout_records', verbose_name='处方id')

    # 药房工作人员
    creator = models.ForeignKey(User, on_delete=models.DO_NOTHING,
                                related_name='created_medicine_handout_records', verbose_name='创建者id')
    create_time = models.DateTimeField(auto_now_add=True, verbose_name='创建时间')

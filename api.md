...
| GET      | /api/reservations/{pk}/                  | 某条预约记录                                 |
| PUT      | /api/reservations/{pk}/                  | 更新某条预约记录                             |
| PATCH    | /api/reservations/{pk}/                  | 更新某条预约记录                             |
| GET      | /api/users/{pk}/reservations/            | 某个用户下的所有预约记录                     |
| GET      | /api/groups/{pk}/reservations/           | 某个科室下的所有预约记录                     |
...
| GET      | /api/reservation-time/{pk}/reservations/ | 某个预约时间段下的所有预约记录（管理员可用） |
| GET      | /api/visits/                             | 所有坐诊时间记录                             |
| POST     | /api/visits/                             | 创建坐诊时间记录                             |
| GET      | /api/visits/{pk}/                        | 某个坐诊时间记录                             |
| PUT      | /api/visits/{pk}/                        | 更新某个坐诊时间记录                         |
| PATCH    | /api/visits/{pk}/                        | 更新某个坐诊时间记录                         |
| GET      | /api/users/{pk}/visits/                  | 某个用户下的所有坐诊时间记录                 |
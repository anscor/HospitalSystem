...
class PayRecord(models.Model):
    patient = models.ForeignKey(
        User, on_delete=models.DO_NOTHING, related_name='paid_records', verbose_name='病人id')
    ...
    creator = models.ForeignKey(User, on_delete=models.DO_NOTHING,
                                related_name='created_pay_records', verbose_name='创建者id')
...
class PayType(models.Model):
    ...
    creator = models.ForeignKey(User, on_delete=models.DO_NOTHING,
                                related_name='created_pay_types', verbose_name='创建者id')
    create_time = models.DateTimeField(auto_now_add=True, verbose_name='创建时间')
    modifier = models.ForeignKey(User, on_delete=models.DO_NOTHING, null=True,
                                 blank=True, related_name='modified_pay_types', verbose_name='修改者id')
...
class PayItem(models.Model):
    record = models.ForeignKey(PayRecord, on_delete=models.DO_NOTHING,
                               related_name='items', verbose_name='缴费单id')
    pay_type = models.ForeignKey(PayType, on_delete=models.DO_NOTHING,
                                 related_name='items', verbose_name='缴费项目id')
    # 数量、次数
...
class RefundRecord(models.Model):
    item = models.ForeignKey(
        PayItem, on_delete=models.DO_NOTHING, related_name='refunds', verbose_name='项目id')
    ...
    creator = models.ForeignKey(User, on_delete=models.DO_NOTHING,
                                related_name='created_refund_records', verbose_name='创建者id')
    create_time = models.DateTimeField(auto_now_add=True, verbose_name='创建时间')
...
class AuditRecord(models.Model):
    ...
    applicant = models.ForeignKey(User, on_delete=models.DO_NOTHING,
                                  related_name='applied_records', verbose_name='申请者id')
    create_time = models.DateTimeField(auto_now_add=True, verbose_name='申请时间')
    auditor = models.ForeignKey(User, on_delete=models.DO_NOTHING,
                                related_name='audited_records', verbose_name='审核者id')
...
class AuditItem(models.Model):
    audit = models.ForeignKey(
        AuditRecord, on_delete=models.DO_NOTHING, related_name='items', verbose_name='审核id')
    receive = models.ForeignKey(
        PayRecord, on_delete=models.DO_NOTHING, related_name='audit_items', verbose_name='收款条目id')
    refund = models.ForeignKey(RefundRecord, on_delete=models.DO_NOTHING,
                               related_name='audit_items', verbose_name='退款条目')
